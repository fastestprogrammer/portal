...
$column = array("SNo","RegistrationNumber","Name","CourseCode","Course","CourseType","Grade");
if($role=="student"){
$column = array("CourseCode","Course","CourseType","Grade");
$query = "SELECT * FROM report where RegistrationNumber like '%$id%'";
}
else{
